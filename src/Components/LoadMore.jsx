...
const LoadMore = () => {
  ...
  {
    /* state for navbar so it can change immediately */
  }
      ...
      <body>
        <div className="navbr">
          <nav className="navbar">
            {" "}
            {/*usestate is used so setnavbar is true then it checks and adds sticky class to nav bar */}
            <div className="content">
              ...
              menuBtn.classList.remove("hide");
                ...
                <li>
                  <a href="#3dsheets">3D Sheets</a>
                </li>
                <li>
                  <a href="#FrontFitting">Front Fitting</a>
                </li>
                <li>
                  <a href="#door">Steel Doors/Gates</a>
                </li>
                <li>
                  <a href="#Modular">Modular Finish</a>
                </li>
                <li>
                  <a href="#SteelRailing">Steel Railing</a>
                </li>
              </ul>
        ...
        <section className="body">
          <section className="work" id="work">
            <h1 className="heading1" id="3dsheets">
              3D Sheets on Doors and Almirah's
            </h1>
            <div className="imgs">
              {Sheets.map((image) => (
                <div className="swiper-slide1">
                  <a
                    href={image}
                    data-lightbox="3dSheets"
                    data-title="3D Sheets"
                  >
                    <img src={image} />
                  </a>
                </div>
            ...
            <h1 className="heading1" id="FrontFitting">
              Front Fitting
            </h1>
            <div className="imgs">
              {front.map((image) => (
                <div className="swiper-slide1">
                  <a
                    href={image}
                    data-lightbox="FrontFitting"
                    data-title="Front Fitting"
                  >
                    <img src={image} />
                  </a>
                </div>
            ...
            <h1 className="heading1" id="Modular">
              Modular Kitchen
            </h1>
            <div className="imgs">
              {modular.map((image) => (
                <div className="swiper-slide1">
                  <a href={image} data-lightbox="Modular" data-title="Modular">
                    <img src={image} />
                  </a>
                </div>
              ))}
            </div>
            <h1 className="heading1" id="SteelRailing">
              Steel Railing
            </h1>
            <div className="imgs">
              {steel.map((image) => (
          ...
          <h1 style={{ "background-color": "black" }} className="heading1">
            Contact
          </h1>
