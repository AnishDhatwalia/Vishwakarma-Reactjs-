...
import SwiperCore, { Navigation, Pagination, Scrollbar, coverflowEffect } from "swiper";
  ...
  return(
    ...
    {images.map((image) => (
      <SwiperSlide zoom  className="">
        <a href={image} data-lightbox="work" data-title="sample work">
        <img src={image} alt="product" className="rounded-lg" /></a>
      </SwiperSlide>
    ))}
  </Swiper>)
}; 
